...
/*retrieve the data from category table*/
...
if($type=='delete')
{
  ...
  $deleteproductondeletecategory_sql="delete from product where categories_id='$id'";
mysqli_query($con, $deleteproductondeletecategory_sql);
...
<div class="row" >
  ...
  <div class="categories_table">
          <div class="categories_header"><p><h1><i>CATEGORIES</i></h1></p>
                <p><a href="manage_categories.php"><h4><i>ADD CATEGORIES</i></h4></a></p>
          </div>
    <table>
    <tr>
      <th>S.NO</th>
 ...
 ?>
    ...
    <tr>
      ...
      else
      {
        ...
        echo "&nbsp; &nbsp;<a href='manage_categories.php?type=edit&id=".$row['id']."'>EDIT</a></span>";
