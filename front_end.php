...
/*grocery background image css  */



.hero-image {
  background: url(grocery.jpg) no-repeat center; 
...
/* grocery back ground image end css  */
...
<div class="hero-image">
  <div class="hero-text" style="color:white;  opacity:rgba(0,0,0,0.3);">
    <h1 style="font-size:50px">Welcome to the Grocery Store</h1>
...
<div class="latest_products" style="overflow:auto;">
    ...
    <div class="latest_product_header"  style=" background-color:#E6E6FA;padding:7px;">
      <p> <h3 style="text-align:center; font-size:25px;">LATEST PRODUCTS</h3></p>
    </div>
      ...
      <div class="latest_image_one_element_div">
          ...
          <div class="latest_image_content_portion">
            ...
            <ul style="list-style-type: none; text-align:center;">
              <li>  MRP.&nbsp; &nbsp; Rs.<del><?php echo $list['mrp']; ?></del>/kg</li>
              <li> Price &nbsp;  &nbsp;  Rs.<?php echo $list['price']; ?>/kg</li>
