      ...
      <div class="latest_image_one_element_div">
          ...
          <div class="latest_image_content_portion">
            ...
            <ul style="list-style-type: none; text-align:center;">
              <li style="text-decoration:line-through;">  MRP.&nbsp;&nbsp;  Rs.<?php echo $list['mrp']; ?>/kg</li>
...
<!-- Footer -->
<footer class="w3-container w3-padding-64 w3-center w3-opacity w3-light-grey w3-xlarge footercss">
