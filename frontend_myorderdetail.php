...
mysqli_query($con,"delete from order_table where  id=$order_id ");
mysqli_query($con,"delete  from order_detail where  order_id=$order_id ");
       header('location:frontend_myorder.php');
...
<div class="header">
  ...
  {
  echo "<a href='frontend_login.php'  class='user_icon' style='text-decoration:none;'><span style='cursor:pointer;  margin-right:10px;'><i  style='font-size:20px'>LOGIN/REGISTER</i></span></a>";
  }
  ?>
...
<div class="cart_table" >
         ...
         <form method="post">
              ...
              <table  style="width:100%; border:1px solid black;">
					...
					$res=mysqli_query($con,"select distinct(order_detail.id),order_detail.*,product.name,product.image from order_detail,product,order_table where order_detail.order_id='$order_id'  and order_table.user_id='$uid'  and product.id=order_detail.product_id");
					$total_price=0;
					...
					<tr>
						...
						<td  style="text-align:center"><a href=""><img src="product/<?php echo $row['image'];  ?>"  width="120px;" height="120px;" alt="product_img"> </a></td> 
...
<input type="submit" name="cancelorder" class="cancelorderbutton" value="Cancel Order">
